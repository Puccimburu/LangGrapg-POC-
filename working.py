...
5. For cost analysis: use costevalutionforllm collection with totalCostInUSD field
6. For prompts: use prompts collection with promptName, promptType fields
7. Always include proper $project stage to limit returned fields
8. For counting queries: use $count instead of $limit
9. For "all" or "show me everything" queries: do NOT include $limit
10. Only use $limit when user asks for "first few", "top 10", or similar limited results
